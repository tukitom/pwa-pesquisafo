...
function updateSplitters() {
  ...
  options = [`<option value="">-- (opcional) --</option>`].concat(
    splitters.map(s => `<option value="${s}">${s}</option>`)
  );
